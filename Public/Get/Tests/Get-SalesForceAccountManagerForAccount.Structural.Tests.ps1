...
$Function=Get-Command Get-SalesForceAccountManagerForAccount
Describe "$($function.Name) Tests" {

   Context "Parameters for $($function.Name)"{

        It 'Has a Parameter called AccountID' {
            $Function.Parameters.Keys.Contains('AccountID') | Should Be 'True'
            }
        It 'AccountID Parameter is Identified as Mandatory being True' {
            [String]$Function.Parameters.AccountID.Attributes.Mandatory | Should be 'True'
            }
        It 'AccountID Parameter is of String Type' {
            $Function.Parameters.AccountID.ParameterType.FullName | Should be 'System.String'
            }
        It 'AccountID Parameter is member of ParameterSets' {
            [String]$Function.Parameters.AccountID.ParameterSets.Keys | Should Be '__AllParameterSets'
            }
        It 'AccountID Parameter Position is defined correctly' {
            [String]$Function.Parameters.AccountID.Attributes.Position | Should be '0'
            }
        It 'Does AccountID Parameter Accept Pipeline Input?' {
            [String]$Function.Parameters.AccountID.Attributes.ValueFromPipeline | Should be 'False'
            }
        It 'Does AccountID Parameter Accept Pipeline Input by PropertyName?' {
            [String]$Function.Parameters.AccountID.Attributes.ValueFromPipelineByPropertyName | Should be 'False'
            }
        It 'Does AccountID Parameter use advanced parameter Validation? ' {
            $Function.Parameters.AccountID.Attributes.TypeID.Name -contains 'ValidateNotNullOrEmptyAttribute' | Should Be 'False'
            $Function.Parameters.AccountID.Attributes.TypeID.Name -contains 'ValidateNotNullAttribute' | Should Be 'False'
            $Function.Parameters.AccountID.Attributes.TypeID.Name -contains 'ValidateScript' | Should Be 'False'
            $Function.Parameters.AccountID.Attributes.TypeID.Name -contains 'ValidateRangeAttribute' | Should Be 'False'
            $Function.Parameters.AccountID.Attributes.TypeID.Name -contains 'ValidatePatternAttribute' | Should Be 'False'
            }
        It 'Has Parameter Help Text for AccountID '{
            $function.Definition.Contains('.PARAMETER AccountID') | Should Be 'True'
            }
